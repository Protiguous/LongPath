...
//
// This source code contained in "UncFileTests.cs" belongs to Protiguous@Protiguous.com and
...
//
// Project: "Pri.Tests", "UncFileTests.cs" was last formatted by Protiguous on 2019/01/12 at 8:16 PM.
...
namespace Tests {
	...
	public class UncFileTests {
		...
		[Test]
		public void TestReadAllText() => Assert.AreEqual( "test" + Environment.NewLine, File.ReadAllText( filePath ) );
		...
		[Test]
		public void TestReplaceWithNullDestination() => Assert.Throws<ArgumentNullException>( () => File.Replace( filePath, null, null ) );
