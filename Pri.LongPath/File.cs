...
namespace Pri.LongPath {
    ...
    public static class File {
        ...
        [NotNull]
        public static FileStream Create( [NotNull] String path, Int32 bufferSize, FileOptions options, [NotNull] FileSecurity fileSecurity ) {

            var fileStream = Create( path.ThrowIfBlank(), bufferSize, options );
        ...
        [NotNull]
        public static FileSecurity GetAccessControl( [NotNull] String path ) {
        ...
        [NotNull]
        public static FileSecurity GetAccessControl( [NotNull] String path, AccessControlSections includeSections ) {
        ...
        public static void SetAccessControl( [NotNull] String path, [NotNull] FileSecurity fileSecurity ) {
            ...
            fileSecurity.SetAccessControlExtracted( name );
        }
